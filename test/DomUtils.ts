...
describe("DomUtils#attr", () => {
    ...
    it("body", () => {
        ...
        expect(DomUtils.attr(document.getElementById("sample1"), "id"))
            .toEqual("sample1");
    });
...
describe("DomUtils#attrAsNumber", () => {
    ...
    it("attr", () => {
        ...
        expect(DomUtils.attrAsNumber(document.getElementById("sample1"), "max"))
            .toBe(10);
    });
...
describe("DomUtils#getBoundingClientRect", () => {
    ...
    it("getBoundingClientRect", () => {
        ...
        expect(rects[0].top)
            .toBe(0);
        expect(rects[0].width)
            .toBe(0);
        expect(rects[0].height)
            .toBe(0);
        ...
        expect(rects[1].top)
            .toBe(0);
        expect(rects[1].width)
            .toBe(0);
        expect(rects[1].height)
            .toBe(0);
    });
...
describe("DomUtils#expansionRects", () => {
    ...
    it("expansionRects", () => {
        ...
        expect(DomUtils.expansionRects(rects))
            .toEqual({
                bottom: 30,
                height: 20,
                left: 10,
...
describe("DomUtils#location", () => {
    ...
    it("body", () => {
        ...
        expect(DomUtils.location(document.getElementById("sample1")))
            .toEqual({x: 0, y: 0});
    });
...
describe("DomUtils#location", () => {
    ...
    it("body", () => {
        ...
        expect(DomUtils.text(document, "#sample1"))
            .toBe("Hello !! World !!");
    });
