...
describe("StringUtils#findUrls", () => {
    ...
    it("hit", () => {
        expect(StringUtils.findUrls("Hello !! World !! http://www.google.com/ Hello !! World !!"))
            .toEqual(["http://www.google.com/"]);
    });

    it("not hit", () => {
        expect(StringUtils.findUrls("Hello !! World !!"))
            .toEqual([]);
    });
...
describe("StringUtils#isNotEmpty", () => {
    ...
    it("is true", () => {
        expect(StringUtils.isNotEmpty("Hello !!"))
            .toBe(true);
    });
...
describe("StringUtils#isNullOrEmpty", () => {
    ...
    it("is true", () => {
        expect(StringUtils.isNullOrEmpty(""))
            .toBe(true);
        expect(StringUtils.isNullOrEmpty(null))
            .toBe(true);
    });

    it("is false", () => {
        expect(StringUtils.isNullOrEmpty("Hello !!"))
            .toBe(false);
    });
